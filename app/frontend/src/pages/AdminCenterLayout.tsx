    ...
    <ProtectedAdminRoute>
      <UahubLayout hideModuleNav>
        <div className="mx-auto max-w-7xl px-4 py-6 lg:px-6 lg:py-8">
          <div className="mb-5 flex items-start gap-3 rounded-3xl border px-5 py-5 shadow-sm backdrop-blur-sm lg:px-6">
            <div className={cn(
            ...
            <div>
              <h1 className={cn("text-xl font-bold", isDark ? "text-slate-100" : "text-slate-900")}>
                {locale === "ua" ? "Адмін центр" : locale === "es" ? "Centro administrativo" : "Admin center"}
              </h1>
              <p className={cn("mt-1.5 max-w-3xl text-sm", isDark ? "text-slate-400" : "text-slate-600")}>
                {locale === "ua"
          ...
          <div className="grid gap-5 lg:grid-cols-[260px_minmax(0,1fr)]">
            <aside className={cn(
              "h-fit rounded-3xl border p-2.5",
